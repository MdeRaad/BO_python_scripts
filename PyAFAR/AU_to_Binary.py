...
au_to_binary.py
===============
Zet AU-kansen uit PyAFAR CSV's om naar 0/1
op basis van één of meer drempelwaardes.

Herkent alleen PyAFAR occurrence-kolommen:
  Occ_au_1, Occ_au_2, ...
...
INPUT_DIR  = PROJECT_DIR / "PyAFAR_data"  # map met de ruwe CSV's
...
def get_au_columns(df: pd.DataFrame) -> list[str]:
    """Geef alleen de Occ_au_* kolommen terug.

    Int_au_* (intensiteit) en andere AU-varianten worden genegeerd.
    """
